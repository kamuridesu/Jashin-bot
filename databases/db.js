...
class Database {
    constructor() {
        ...
        this.group_infos = this.database.define('group_infos', { // create our group_infos table
            ...
            chatbot_on: {
                type: Sequelize.BOOLEAN,   // set the type of the chatbot_on column
                defaultValue: false // set the default value of the chatbot_on column
            }
        });
                ...
                case 'group_infos': // if the table name is group_infos
                    try{
                        const result = await this.group_infos.create({ // create a new row in the group_infos table
                            ...
                            chatbot_on: infos.chatbot_on // set the chatbot_on column to the chatbot_on parameter
                        });
                        console.log(result);
                    } catch (err) {
                        console.log(err);
